  ...
  return (
    <>
      <div className="h-0 w-0 overflow-hidden">
        <div
          className="flex w-[960px] flex-col justify-between bg-white px-12 pb-10"
          ref={exportRefCallback}
        >
          <div>
            <div className="flex items-center">
              <div className="relative mt-[40px] flex h-[220px] w-[220px] items-center justify-center">
                <img
              ...
              <div className="ml-[32px] flex min-w-0 flex-col ">
                <span
                  className={`truncate text-[50px] font-semibold leading-[2] `}
                >
                  {content.song.title}
                </span>
                <span
                  className={` -mt-[32px] truncate text-[48px] font-light leading-[2] text-gray-400`}
                >
                  {content.song.artist}
                </span>
              </div>
          ...
          <div>
            <div className="flex items-center">
              <img
                className="mr-[10px] mt-[36px] h-[48px] w-[48px]"
                src={logo}
                alt="disc"
              />
