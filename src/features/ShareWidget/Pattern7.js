...
const Pattern7 = ({ content, isMysong, onSharing }) => {
  ...
  return (
    <>
      <div className="h-0 w-0 overflow-hidden">
        <div
          className="relative flex w-[960px] flex-col justify-between bg-[#FDEAE0] px-[86px] pt-[42px] pb-[86px]"
          ref={exportRefCallback}
        >
          <img
            src={santaHat}
            alt="Santa Hat"
            className="absolute top-[-200px] left-[-100px] z-0 w-[550px]"
          />
          <img
            src={santaHat}
            alt="Santa Hat"
            className="absolute bottom-[-300px] right-[-200px] w-[800px]"
          />
          ...
          <div className="z-10">
            <div className="flex items-center">
              ...
              <div className="ml-[32px] flex min-w-0 flex-col ">
                <div className="flex w-[580px] flex-row">
                  <span
                    className={`flex w-[580px] flex-row truncate text-[44px] font-bold italic leading-[2] text-white`}
                  >
                    {content.song.title}
                  </span>
                  <div
                ...
                <span
                  className={` -mt-[28px] truncate text-[42px] font-normal italic leading-[2] text-[#B9B9B9]`}
                >
                  {content.song.artist}
                </span>
              </div>
          ...
          {isMysong && (
            <span className="mt-[20px]  text-[32px] font-bold text-[#D1AFA7]">
              @{user.username}
            </span>
          )}
          ...
          <div className="mt-[32px] mb-[48px] flex w-full flex-row items-center px-[8px] pr-[120px] text-[28px] font-thin text-[#383838]">
            <span
              style={{
                wordBreak: "break-word",
                whiteSpace: "pre-line",
