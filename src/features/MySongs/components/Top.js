...
function Top({ pageLayout, setPageLayout, currentTab, setCurrentTab }) {
  ...
  return (
    <div className="gimmesong-bg sticky top-[110px] z-[49] flex w-full items-center justify-evenly pt-6 pb-2">
        ...
        >
          <div className="flex items-center justify-center">
            <svg
              ...
              fill="none"
            >
              <rect x="5" width="13" height="13" rx="6.5" fill="currentColor" />
              <path
            ...
            <span className="gimmesong-secondary-font ml-2 text-sm">Full</span>
          </div>
        </button>
        <button
          type="button"
        ...
        >
          <div className="flex items-center justify-center">
            ...
            >
              ...
              <rect y="12" width="3" height="3" rx="1.5" fill="currentColor" />
            ...
            <span className="gimmesong-secondary-font ml-2 text-sm">Grid</span>
          </div>
        </button>
      </div>
    </div>
