...
import First from "../assets/AddToRequest/1.png";
import Second from "../assets/AddToRequest/2.png";
import Third from "../assets/AddToRequest/3.png";
import Forth from "../assets/AddToRequest/4.png";

function AddSongToRequest() {
    ...
    <>
      ...
      >
        ...
        <AlertDialogContent borderRadius={25} marginX={4}>
          <AlertDialogHeader>How to add song to request?</AlertDialogHeader>
          <AlertDialogCloseButton />
          <AlertDialogBody
            display={`flex`}
            ...
            {activeStep === 2 && (
              <div className="mt-3 flex flex-col items-center">
                ...
                <div className="mt-2 flex items-center">
                  ...
                  <p className="text-md">The request page will show.</p>
                </div>
              </div>
            )}
            {activeStep === 3 && (
              <div className="mt-3 flex flex-col items-center">
                ...
                <div className="mt-2 flex items-center">
                  ...
                  <p className="text-md">
                  At the top right, Click <b>Add songs</b> button.
                  </p>
                </div>
              </div>
            )}
            ...
            {activeStep === 4 && (
              <div className="mt-3 flex flex-col items-center">
                ...
                <div className="mt-2 flex items-center">
                  ...
                  <p className="text-md">Select your song and put your message.</p>
                </div>
              </div>
            )}
...
export default AddSongToRequest;
