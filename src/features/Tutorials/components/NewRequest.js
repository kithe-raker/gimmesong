...
import First from "../assets/NewRequest/1.png";
import Second from "../assets/NewRequest/2.png";
import Third from "../assets/NewRequest/3.png";
import Forth from "../assets/NewRequest/4.png";
    ...
    <>
      ...
      >
        ...
        <AlertDialogContent borderRadius={25} marginX={4}>
          <AlertDialogHeader>How to add your own request?</AlertDialogHeader>
          <AlertDialogCloseButton />
          <AlertDialogBody
            display={`flex`}
              ...
              <div className="mt-3 flex flex-col items-center">
                ...
                <div className="mt-2 flex items-center">
                  ...
                  <p className="text-md">
                    ...
                    button at the bottom right to add new request.
                  </p>
                </div>
              </div>
            )}
            {activeStep === 3 && (
              <div className="mt-3 flex flex-col items-center">
                ...
                <div className="mt-2 flex items-center">
                  ...
                  <p className="text-md">
                    Put the request name in text box. If you want to post as <b>anonymous</b> you can check in checkbox below.
                  </p>
                </div>
              </div>
            )}
            {activeStep === 4 && (
              <div className="mt-3 flex flex-col items-center">
                ...
                <div className="mt-2 flex items-center">
                  ...
                  <p className="text-md">
                    <b>Congratulation</b>! You request is showing.
                  </p>
                </div>
              </div>
            )}
