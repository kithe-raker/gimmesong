...
function Feed() {
  ...
  return (
    <>
      <div className="gimmesong-bg sticky top-[120px] z-50 flex w-full items-center justify-between py-2">
      ...
      <div className="mx-auto flex w-full max-w-md flex-col items-center py-3">
