...
function Home() {
  ...
  const openDefaultBrowser = () => {
    window.open("https://gimmesong.link", "_system", "location=yes");
  };
  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-md flex-col items-center justify-center py-[60px] pt-[80px]">
      ...
      <button
        ...
        className="mt-2 flex h-12 w-[260px] items-center justify-center rounded-full bg-black font-bold text-white transition duration-150 ease-in-out hover:bg-gray-600"
      >
